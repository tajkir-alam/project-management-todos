    ...
    return (
        <header className='relative overflow-x-clip bg-white border-b-[1px] border-[#E9E9E9] px-4 lg:px-10 py-2 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div onClick={(e) => e.stopPropagation()} className={`z-50 absolute w-[300px] ${showProfile ? 'right-5 lg:right-10' : '-right-96'} top-[calc(100%+3px)] flex items-center justify-between bg-white p-3 shadow-[-2px_2px_10px_1px_rgba(0,0,0,0.1)] rounded duration-300`}>
